...
class FrontageWorkOrderScreen extends StatelessWidget {
  const FrontageWorkOrderScreen({super.key});
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              ServiceTypeCard(serviceType: 'maintenance.frontage_works'.tr(context)),
              ...
              LabelText(labelText: 'maintenance.frontage_type'.tr(context)),
              SizedBox(height: 16.h,),
              ...
              SizedBox(height: 32.h,),
              LabelText(labelText: 'maintenance.the_area_to_be_frontage'.tr(context)+'maintenance.length_width'.tr(context)+' :',),
              SizedBox(height: 16.h,),
