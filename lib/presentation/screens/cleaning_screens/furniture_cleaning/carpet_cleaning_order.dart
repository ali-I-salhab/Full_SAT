...
class CarpetCleaningOrderScreen extends StatelessWidget {
  const CarpetCleaningOrderScreen({super.key});
          ...
          child: Column(
            children: [
              SizedBox(height: 16.h,),
               ServiceTypeCard(serviceType: 'cleaning.carpet_cleaning'.tr(context)),
              SizedBox(height: 32.h,),

              LabelText(labelText: 'cleaning.how_many_carpets?'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
              AppTextField( inputType: TextInputType.number,),
              SizedBox(height: 32.h,),
              LabelText(labelText: 'cleaning.what_type_of_carpet_cleaning_do_you_need?'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
              ...
              SizedBox(height: 32.h,),
  LabelText(labelText: 'cleaning.carpet_condition?'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
              CustomSlider(
                division: 4,
              ),
              SizedBox(height: 32.h,),
              LabelText(labelText: 'cleaning.what_are_the_dimensions_of_your_carpets?'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
