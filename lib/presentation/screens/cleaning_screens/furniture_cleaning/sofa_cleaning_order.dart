...
class SofaCleaningOrderScreen extends StatelessWidget {
  const SofaCleaningOrderScreen({super.key});
          ...
          child: Column(
            children: [
              SizedBox(height: 16.h,),
               ServiceTypeCard(serviceType: 'cleaning.sofa_cleaning'.tr(context)),
              SizedBox(height: 32.h),

              LabelText(labelText: 'cleaning.how_many_sofas_do_you_want_to_clean?'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
              AppTextField( inputType: TextInputType.number,),
              SizedBox(height: 32.h,),

              LabelText(labelText: 'cleaning.what_type_of_sofa_cleaning_do_you_need?'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
              ...
              SizedBox(height: 32.h,),
              LabelText(labelText: 'cleaning.sofa_condition?'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
              CustomSlider(
                division: 4,
              ),
              SizedBox(height: 32.h,),
              LabelText(labelText: 'cleaning.what_material_is_your_sofa_made_of?'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
              CustomCheckBox(checkboxTitle: 'cleaning.cotton'.tr(context)),
              CustomCheckBox(checkboxTitle: 'cleaning.leather'.tr(context)),
              CustomCheckBox(checkboxTitle: 'cleaning.vinyl'.tr(context)),
