...
class HardworkCategoriesScreen extends StatelessWidget {
  const HardworkCategoriesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          appBar: CustomAppBar(title: 'cleaning.hard_work_cleaning'.tr(context)),
          body: Padding(
                ...
                GridView.builder(
                    ...
                    itemBuilder: (context,index){
                      return InkWell(
                          onTap: (){
                            if(index == 0){
                              context.navigateTo(routeName: Routes.tankCleaningOrderViewRoute);
                            }else if(index == 1){
                              context.navigateTo(routeName: Routes.swimmingPoolCleaningOrderViewRoute);
                            }else if(index == 2){
                              context.navigateTo(routeName: Routes.streetCleaningOrderViewRoute);
                            }else if(index == 3){
                              context.navigateTo(routeName: Routes.gardensCleaningOrderViewRoute);
                            }
                            else if(index == 4) {
                              context.navigateTo(routeName: Routes
                                  .manholeCleaningOrderViewRoute);
                            }
                          },
