...
class ManholeCleaningOrderScreen extends StatelessWidget {
  const ManholeCleaningOrderScreen({super.key});
...
SizedBox(height: 16.h,),
               ServiceTypeCard(serviceType: 'cleaning.manhole_cleaning'.tr(context)),
              SizedBox(height: 32.h,),
              LabelText(labelText: 'cleaning.cleaning_Type:'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
              CustomCheckBox(checkboxTitle: 'cleaning.cleaning_filters'.tr(context)),
              CustomCheckBox(checkboxTitle: 'cleaning.checking_networks_and_barriers'.tr(context)),
              CustomCheckBox(checkboxTitle: 'cleaning.inspection_of_pipes_and_communications'.tr(context)),
              CustomCheckBox(checkboxTitle: 'cleaning.clean_the_drain_holes'.tr(context)),
              CustomCheckBox(checkboxTitle: 'cleaning.control_of_algae_and_seaweed'.tr(context)),
              CustomCheckBox(checkboxTitle: 'cleaning.inspection_of_water_pumps'.tr(context)),
              SizedBox(height: 32.h,),

              LabelText(labelText: 'cleaning.number_of_manholes?'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
