...
import 'package:osta/presentation/components/cleaning_orders_components/question_row.dart';
...
class BuildingCleaningOrderScreen extends StatelessWidget {
  const BuildingCleaningOrderScreen({super.key});
          ...
          child: Column(
            children: [
              SizedBox(height: 16.h,),
               ServiceTypeCard(serviceType: 'cleaning.building_cleaning'.tr(context)),
              ...
              Row(
                children: [
                  Expanded(child: CustomRadioButton(radioTitle: 'cleaning.unfurnitured'.tr(context), radioVal: 'unfurnitured', groupVal: 'furnitured')),
                  Expanded(child: CustomRadioButton(radioTitle: 'cleaning.furnitured'.tr(context), radioVal: 'furnitured', groupVal: 'furnitured')),
                ],
              ),
              SizedBox(height: 32.h,),
              ...
              AppTextField( inputType: TextInputType.number,),
              SizedBox(height: 32.h,),
                   LabelText(labelText: 'cleaning.how_many_rooms'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
              AppTextField( inputType: TextInputType.number,),
              SizedBox(height: 32.h,),
              LabelText(labelText: 'cleaning.what_is_the_area_of_the_house_in_square_metres'.tr(context),padding: 30,),
              SizedBox(height: 16.h,),
              CustomSlider(),
              SizedBox(height: 32.h,),
              QuestionRaw(questionText: 'cleaning.are_there_elevators?'.tr(context)),
              SizedBox(height: 32.h,),
              QuestionRaw(questionText: 'cleaning.is_there_a_basement?'.tr(context)),
              SizedBox(height: 32.h,),
              QuestionRaw(questionText: 'cleaning.are_there_ruins?'.tr(context)),
              SizedBox(height: 32.h,),
          MoreDetailsRow(),
              SizedBox(height: 16.h,),
